...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        bouncePath.add("Bounce0.wpilib.json");
        bouncePath.add("Bounce1.wpilib.json");
        bouncePath.add("Bounce2.wpilib.json");
        bouncePath.add("Bounce3.wpilib.json");
        ...
        ArrayList<String> galacticSearchB2 = new ArrayList<String>();
        galacticSearchB2.add("GalacticSearchBlue2.wpilib.json");
        chooser.addOption("Galactic Search Blue 2", galacticSearchB2);

        ArrayList<String> galacticSearchB = new ArrayList<String>();
        galacticSearchB.add("GSearchBlue1.wpilib.json");
        chooser.addOption("Galactic Search Blue", galacticSearchB);

        ArrayList<String> turn = new ArrayList<String>();
        turn.add("Turn.wpilib.json");
        chooser.addOption("Turn", turn);
