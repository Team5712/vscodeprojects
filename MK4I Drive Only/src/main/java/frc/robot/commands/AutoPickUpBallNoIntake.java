...
public class AutoPickUpBallNoIntake extends CommandBase {
  ...
  public AutoPickUpBallNoIntake(Intake intake, Magazine magazine, Shooter shooter, double shooteSpeed, double setHoodAngle) {
