...
public class Climber extends SubsystemBase {
  ...
  public boolean getLimitSwitchRightDown() {
    return rightClimber.isRevLimitSwitchClosed() == 0;
  }
  
  public boolean getLimitSwitchRightUp() {
    return rightClimber.isFwdLimitSwitchClosed() == 0;
  }

  public boolean getLimitSwitchLeftUp() {
    return leftClimber.isRevLimitSwitchClosed() == 0;
  }
  
  public boolean getLimitSwitchLeftDown() {
    return leftClimber.isFwdLimitSwitchClosed() == 0;
  ...
  public void periodic() {
    ...
    SmartDashboard.putBoolean("limitSwitch_left_up", getLimitSwitchLeftUp());
    SmartDashboard.putBoolean("limitSwitch_left_down", getLimitSwitchLeftDown());
    SmartDashboard.putBoolean("limitSwitch_right_up", getLimitSwitchRightUp());
    SmartDashboard.putBoolean("limitSwitch_right_down", getLimitSwitchRightDown());
  }
}
